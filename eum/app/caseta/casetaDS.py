...
def interface():
	...
	class Ventana(QDialog):
		...
		def __init__(self):
			...
			self.bregresar.clicked.connect(lambda:self.cambia(18))
			...
			self.bsellado.clicked.connect(lambda:self.cambia(23))
			self.bl1.clicked.connect(lambda:self.abrirBarrera(11))
			self.bl2.clicked.connect(lambda:self.abrirBarrera(12))
			self.bl3.clicked.connect(lambda:self.abrirBarrera(13))
			self.bl4.clicked.connect(lambda:self.abrirBarrera(14))
			self.bl5.clicked.connect(lambda:self.abrirBarrera(15))
			self.bl6.clicked.connect(lambda:self.abrirBarrera(16))
			self.bl7.clicked.connect(lambda:self.abrirBarrera(17))
			self.bl8.clicked.connect(lambda:self.abrirBarrera(18))
			self.bl9.clicked.connect(lambda:self.abrirBarrera(19))
			self.bsinpropina.clicked.connect(lambda:self.abrirBarrera(8))
			self.bsellado.clicked.connect(lambda:self.abrirBarrera(8))
	...
	################MODS########
		...
		def imprimeCorteCaja(self):
			...
			os.system("sudo python3 /home/pi/Documents/eum/app/caseta/corte/imprimeCorte.py")
		...
		def abrirBarrera(self,tipo):
			...
			if(tipo==9):
				...
				if(result==1):
					...
					conn.commit()
					self.abrela()
			if(tipo>10):#Tolerancia con sello, seleccionar local
				if(result==1):
					print("FOLIO YA REGISTRADO")	
					mensajeBoletoUsado=1
				else:
		...
		def montos(self):
			...
			if(mensajeTolerancia==1):
				...
				self.bsellado.setEnabled(True)
			else:
				self.bsellado.setEnabled(False)
...
def obtenerPlazaYLocalidad():
	global nom, loc
	try:
		connection = psycopg2.connect(database='caseta',user='postgres',password='Postgres3UMd6', host='localhost')
